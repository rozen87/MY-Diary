...
export default function HeroCard({ language, data }: Props) {
  return (
    <LayoutBox className="relative overflow-hidden rounded-[40px] border border-white/20 bg-white/20 backdrop-blur-2xl">
      ...
      <div className="relative z-10 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="max-w-5xl text-2xl leading-[0.9] font-black md:text-5xl">
            {data.title[language]}
          </h3>
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            <div
              key={item}
              className="rounded-full border border-white/20 bg-black/80 px-4 py-2 text-sm font-semibold text-white backdrop-blur-xl"
            >
              {item}
            </div>
          ))}
